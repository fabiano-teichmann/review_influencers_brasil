...
async def on_message(message: cl.Message):
    data = await call_gpt_async(cl=cl, content_system=prompt.prompt_role_system, content_user=message.content)
...
async def on_action_analyze_data(action: cl.Action):
    ...
    data = await call_gpt_async(cl=cl, content_system=prompt.prompt_role_system, content_user=message)
